...
{
    public class MVVMGameplayFormServiceFactory
    {
        ...
        public MVVMGameplayFormServiceFactory(
        ...
        public IDomainFormService Create()
        {
            ...
            // _domainFormService.Register<GameOverForm>(gameOverForm);
            //
            ...
            // _domainFormService.Register<LevelCompletedForm>(levelCompletedForm);
            //
            //
            ...
            // _domainFormService.Register<TutorialForm>(tutorialForm);
            //
