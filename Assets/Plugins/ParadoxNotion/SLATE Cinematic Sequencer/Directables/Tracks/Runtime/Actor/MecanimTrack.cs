...
using Plugins.ParadoxNotion.SLATE_Cinematic_Sequencer.Directables.Clips.Runtime.MecanimTrack;
    ...
    public class MecanimTrack : CutsceneTrack
    {
        ...
        protected override void OnEnter() {
            ...
            foreach ( var track in ( parent as CutsceneGroup ).tracks.OfType<MecanimTrack>().Where(t => t.isActive).Reverse() ) {
                clips.AddRange(track.clips.OfType<MecanimBaseClip>().Where(a => a.isValid).Cast<IDirectable>());
            }
