...
namespace Plugins.ParadoxNotion.SLATE_Cinematic_Sequencer.Directables.Clips.Runtime.ActionTrack.ActorActions.Transform
{
    ...
    public class AttachObjectPrefab : ActorActionClip
    {
        ...
        [Required]
        public UnityEngine.Transform targetPrefab;
        ...
        void Do() {
            instance = (UnityEngine.Transform)Instantiate(targetPrefab);
