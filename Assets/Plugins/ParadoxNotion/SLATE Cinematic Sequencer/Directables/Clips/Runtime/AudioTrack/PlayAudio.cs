...
namespace Plugins.ParadoxNotion.SLATE_Cinematic_Sequencer.Directables.Clips.Runtime.AudioTrack
{
    ...
    public class PlayAudio : ActionClip, ISubClipContainable
    {
        ...
        private Tracks.Runtime.AudioTrack track {
            get { return (Tracks.Runtime.AudioTrack)parent; }
        }
