...
namespace Plugins.ParadoxNotion.SLATE_Cinematic_Sequencer.Directables.Clips.Runtime.AnimatorTrack
{
    ...
    [Attachable(typeof(Tracks.Runtime.Actor.AnimatorTrack))]
    public class PlayAnimatorClip : ActorActionClip, ISubClipContainable
    {
        ...
        private Tracks.Runtime.Actor.AnimatorTrack track { get { return (Tracks.Runtime.Actor.AnimatorTrack)parent; } }
