...
namespace Plugins.ParadoxNotion.SLATE_Cinematic_Sequencer.Directables.Clips.Runtime.VideoTrack
{

    [Attachable(typeof(Tracks.Runtime.Director.VideoTrack))]
    [Name("Video Clip")]
    ...
    public class PlayVideo : ActionClip, ISubClipContainable
    {
        ...
        private Tracks.Runtime.Director.VideoTrack track {
            get { return (Tracks.Runtime.Director.VideoTrack)parent; }
        }
