...
using Plugins.ParadoxNotion.SLATE_Cinematic_Sequencer.Design.Editor.Other;
...
using Plugins.ParadoxNotion.SLATE_Cinematic_Sequencer.Directables.Tracks.Runtime;
...
using UnityEditor;
using UnityEngine;
using ColorUtility = Plugins.ParadoxNotion.SLATE_Cinematic_Sequencer.Utility.ColorUtility;

namespace Plugins.ParadoxNotion.SLATE_Cinematic_Sequencer.Design.Editor.Windows
{
