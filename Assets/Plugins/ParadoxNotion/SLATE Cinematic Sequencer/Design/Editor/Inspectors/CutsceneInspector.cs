...
namespace Plugins.ParadoxNotion.SLATE_Cinematic_Sequencer.Design.Editor.Inspectors
{
    ...
    public class CutsceneInspector : UnityEditor.Editor
    {
        ...
        private static Dictionary<Object, UnityEditor.Editor> directableEditors = new Dictionary<Object, UnityEditor.Editor>();
        private static UnityEditor.Editor currentDirectableEditor;
        ...
        static void DoSelectionInspector() {
            ...
            UnityEditor.Editor newEditor = null;
            if ( !directableEditors.TryGetValue(selection, out newEditor) ) {
                directableEditors[selection] = newEditor = UnityEditor.Editor.CreateEditor(selection);
            }
